...
Thigh = {
  ...
  AnyVec3 KneeJointAxis = ..Sign*{0.09091897, 0.06445389, 0.9937703}*.TF'/vnorm({0.09091897, 0.06445389, 0.9937703});  ///< Temporarily not used
  
  AnyVec3 PatellaFemurJoint = {0.001859503, 0.01200243, -0.004400671}*.TF';
  AnyVec3 PatellaFemurJointAxis = ..Sign*{0.09663987, -0.009576934, 0.9952733}*.TF'/vnorm({0.09663987, -0.009576934, 0.9952733});
};

Patella = {
  AnyFunTransform3D &Scale = ..Seg.Patella.Scale;
  AnyVec3 PatellaFemurJoint = {-0.04425682, -0.001883169, 0.0}*.TF';
  AnyVec3 PatellaFemurJointAxis = ..Sign*{0.09663987, -0.009576935, 0.9952733}*.TF'/vnorm({0.09663987, -0.009576935, 0.9952733});
...
Talus = {
  ...
  AnyVec3 SubTalarJointAxis = ..Sign*-1*{ 0.8784254,  0.4637787, 0.1152306}*.TF';
...
Foot = {
  ...
  AnyVec3 SubTalarJointAxis = ..Sign*-1*{ 0.8784254,  0.4637787, 0.1152306}*.TF'/vnorm({ 0.8784254,  0.4637787, 0.1152306});
