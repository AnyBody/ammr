...
The DOI is also usefull when citing the AMMR. For example, when citing the AMMR 2.2.2:

.. rst-class:: without-title

.. note::  Lund, Morten Enemark, Tørholm, Søren, et al. (2019, May 13). The AnyBody Managed Model Repository (AMMR) (Version 2.2.2). Zenodo. https://doi.org/10.5281/zenodo.3404750
