...
- Webcast: [A lumbar spine model with facets joints and a dynamic stabilization device](https://www.anybodytech.com/webcasts/a-lumbar-spine-model-with-facets-joints-and-a-dynamic-stabilization-device/)
- Webcast: [Implementation of facet joints in a lumbar spine model](https://www.anybodytech.com/webcasts/implementation-of-facet-joints-in-a-lumbar-spine-model/)
