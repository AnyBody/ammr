...
- {doc}`Prediction of ground reaction forces </grf_prediction/grf-prediction>`
...
:::{seealso}
:class: margin
[The AnyBody Tutorials](https://anyscript.org/tutorials/Scaling/index.html), and the lesson on using the
...
{doc}`This section </grf_prediction/grf-prediction>` contains further documentation on how to use ground reaction force prediction in the AnyMoCap framework.
