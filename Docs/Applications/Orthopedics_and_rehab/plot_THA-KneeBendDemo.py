...
**Main file:** :file:`Application/Examples/THA-KneeBendDemo/THA-KneeBendDemo.main.any`
...
component [#fn1]_ are included into the model and a contact force between these
